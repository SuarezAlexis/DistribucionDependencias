...
namespace DistribucionDependencias.WebUI.Infrastructure
{
    public class NinjectDependencyResolver : IDependencyResolver
    {
        ...
        {
            Mock<IArticuloRepository> mock = new Mock<IArticuloRepository>();
            mock.Setup(m => m.Articulos).Returns(new List<Articulo> {
            ...
            kernel.Bind<IArticuloRepository>().ToConstant(mock.Object);
        }
    }
}